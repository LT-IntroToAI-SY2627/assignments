...
assert classify_cost(150) == "expensive", "classify_cost test 1 failed"
assert classify_cost(75) == "normal", "classify_cost test 2 failed"
assert classify_cost(25) == "cheap", "classify_cost test 3 failed"
assert classify_cost(5) == "free", "classify_cost test 4 failed"
